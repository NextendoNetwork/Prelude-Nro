...
static const char *s_strings[STR_COUNT][4] = {
    ...
    [STR_RAIL_S3]     = { "Splatoon 3", "Splatoon 3", "Splatoon 3", "Splatoon 3" },
    [STR_RAIL_LANG]   = { "Language",   "Idioma",     "Idioma",     "Langue" },

    [STR_S3_TITLE]    = { "Splatoon 3 patches",
                          "Parches de Splatoon 3",
                          "Correcoes de Splatoon 3",
                          "Correctifs Splatoon 3" },
    ...
    [STR_S3_MISSING]  = { "Not on the SD card. Splatoon 3 will fail with 2122-2403.",
                          "No estan en la tarjeta. Splatoon 3 fallara con 2122-2403.",
                          "Nao estao no cartao. Splatoon 3 vai falhar com 2122-2403.",
                          "Absents de la carte. Splatoon 3 echouera avec 2122-2403." },
    ...
    [STR_S3_WHERE]    = { "On the card: atmosphere/exefs_patches/s3certbypass",
                          ...
                          "Sur la carte : atmosphere/exefs_patches/s3certbypass" },
    ...
    [STR_S3_VERSION]  = { "Avoid updating the game: a new version needs new patches.",
                          "Evita actualizar el juego: una version nueva necesita parches nuevos.",
                          "Evite atualizar o jogo: uma versao nova precisa de correcoes novas.",
                          "Evitez de mettre le jeu a jour : une version neuve exige d'autres correctifs." },
